...
The goal of cwtCensus is to provide a fast and memory efficient tool for cohort reconstruction using point and bootstrapped estimates. Writing efficient code for cohort reconstruction can be challenging, so we developed cwtCensus to abstract away the details of tweaking R code and designing algorithms. With this package, you can generate bootstrapped cohort reconstruction with just one click!
...
This is a basic example which shows you how to solve a common cohort reconstruction problem:
