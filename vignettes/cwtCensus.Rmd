...
-   elsr: early life survival rate is the proportion of the abundance of fish first month in ocean, relative to the total release number (O'Farrell et al. 2012).
...
O'Farrell M, Mohr M, Grover A, Satterthwaite W (2012). “Sacramento River Winter Chinook Cohort Reconstruction: Analysis of Ocean Fishery Impacts.” NOAA Technical Memorandum.

Salmon Technical Team (2021). “STT Recommendations for Hooking Mortality Rates in 2000 Recreational Ocean Chinook and Coho Fisheries.” Pacific Fishersy Management Council, Portland. https://www.pcouncil.org/documents/2021/05/stt-recommendations-for-hooking-mortality-rates-in-2000-recreational-ocean-chinook-and-coho-fisheries.pdf/.
